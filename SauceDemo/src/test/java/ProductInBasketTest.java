...
public class ProductInBasketTest extends BaseTest {
  ...
  public void checkCartTest() {
    ...
    String nameProduct = driver.findElement(By.xpath("//div[text()='Sauce Labs Backpack']")).getText();
    ...
    String nameProductInBasket = driver.findElement(By.xpath("//div[text()='Sauce Labs Backpack']")).getText();
